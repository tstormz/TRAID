...
ActiveRecord::Schema.define(version: 20160116194535) do
  ...
  add_index "items_transactions", ["item_id", "transaction_id"], name: "index_items_transactions_on_item_id_and_transaction_id", using: :btree
